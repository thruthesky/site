    ...
    constructor(
        ...
        if (!languageCode) {
            ...
            if (this.site.studentTheme) {
                 ...
                 * If browser language is not one of 'en', 'ko', 'ja', 'zh', then user 'ko'.
                 */
                const _user_lang = language.getUserLanguage();
                // console.log('_user_lang', _user_lang);
                if (_user_lang !== 'en' && _user_lang !== 'ko' && _user_lang !== 'zh' && _user_lang !== 'ja') {
                    languageCode = 'ko';
                }
